{
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      # Configuration Variables Grouped Cleanly
      config = {
      ...
      # 1. Template out configurations cleanly using substituteAll
      ...
      # 2. Package the master script with configurations baked into it
    ...
    in
    {
      ...
      packages.${system} = {
        ...
        # Ultra-short, optimized wrappers passing parameters to the compiled master script executable
